...
Nonostante i problemi riscontrati in fase iniziale di sviluppo, dovuti all'inesperienza nel campo, siamo riusciti a sviluppare un sistema che rispondesse ai requisiti preposti: distribuzione del carico, robustezza del sistema, distribuzione del sistema su scala geografica, tolleranza ai guasti, sincronizzazione degli eventi associati allo stato dell'applicazione ed infine la consistenza dei dati.
Il soddisfacimento di tutti questi obiettivi \'e stato avvalorato dai test funzionali effettuati.
Seppur soddisfatti gli obbietti essenziali per la realizzazione del sistema, sono stati identificati eventuali miglioramenti; alcuni dei quali sono stati ritenuti secondari perch\'e non adeguati per l'attuale bacino d'utenza.
...
\renewcommand\partname{Riferimenti Bibliografici}
